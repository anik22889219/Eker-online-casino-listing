...
export class LoggingService {
  private static isProduction = typeof process !== "undefined" && process.env ? process.env.NODE_ENV === "production" : ((import.meta as any).env ? (import.meta as any).env.PROD : false);
