    ...
    return (
      ...
      >
        ...
        <div className="space-y-5">
          ...
          <div className="relative py-1 text-center text-[10px] uppercase font-bold tracking-wider text-slate-500">
            <span className="bg-slate-950 px-3 relative z-10">Or Sign In with Email</span>
            <hr className="absolute inset-x-0 top-1/2 -translate-y-1/2 border-slate-800 z-0" />
          </div>

          <form id="email-login-form" onSubmit={handleEmailAuth} className="space-y-3.5 bg-slate-900/40 p-4 border border-slate-800/80 rounded-2xl">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 border border-slate-800 rounded-xl text-xs font-medium focus:border-indigo-500 focus:outline-hidden bg-slate-900/80 text-slate-100 placeholder-slate-600"
              />
            </div>
