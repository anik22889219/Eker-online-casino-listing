          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            <div className="h-20 w-20 rounded-2xl bg-white p-2 border border-slate-100 shadow-lg overflow-hidden shrink-0 flex items-center justify-center">
              {(() => {
                ...
                const isCustomLogo = casino.casinoLogo && casino.casinoLogo.trim() !== "" && casino.casinoLogo !== "/tk10_logo.jpg" && casino.casinoLogo !== "/qq777_logo.jpg";
                if (!isCustomLogo) {
                  if (casino.casinoName) {
                    ...
                    } else if (theme?.globalSettings?.logoUrl) {
                      resolvedLogo = theme.globalSettings.logoUrl;
                    }
                  } else if (theme?.globalSettings?.logoUrl) {
                    resolvedLogo = theme.globalSettings.logoUrl;
                  }
