            ...
            >
              <div>
                ...
                <h4 className="text-sm font-black text-slate-900 tracking-tight mb-2">
                  {req.casinoName} {req.gameName ? <span className="text-indigo-600 font-bold text-xs">({req.gameName})</span> : null}
                </h4>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {activeRequest.screenshot && (
                  <div>
                    ...
                    <div className="border border-slate-200 rounded-xl overflow-hidden shadow-xs bg-slate-50 flex justify-center">
                      <LightboxImage
                        src={activeRequest.screenshot}
                        alt="Jackpot proof attachment"
                        title={`${activeRequest.casinoName} - Jackpot Screenshot`}
                        subtitle={`Submitted by ${activeRequest.name} ($${activeRequest.amount})`}
                  ...
                  <div>
                    ...
                    <div className="border border-slate-200 rounded-xl overflow-hidden shadow-xs bg-slate-50 flex justify-center">
                      <LightboxImage
                        ...
                        title={`${activeRequest.casinoName} - Balance Screenshot`}
                        subtitle={`Submitted by ${activeRequest.name}`}
                        className="w-full object-contain max-h-48"
                        containerClassName="w-full"
                      />
                    </div>
