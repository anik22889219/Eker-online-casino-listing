...
const getNormalizedLogo = (casino: any) => {
  ...
  // If the user has explicitly uploaded/configured a custom brand logo, use it
                    ...
                    <div className="w-16 h-16 rounded-2xl border bg-white overflow-hidden shrink-0 flex items-center justify-center p-1.5">
                      {editFields.casinoLogo ? (
                        <LightboxImage
                          ...
                          alt="Logo"
                          title={`${editFields.casinoName || "Casino"} - Logo`}
                ...
                <div className="border border-slate-200 rounded-2xl p-4 bg-slate-50/30">
                  ...
                  <div className="space-y-4">
                    {editFields.bannerImage && (
                      <div className="w-full h-40 rounded-xl border overflow-hidden bg-slate-900 flex items-center justify-center">
                        <LightboxImage
                          src={editFields.bannerImage}
                          alt="Banner"
                          title={`${editFields.casinoName || "Casino"} - Lander Banner`}
