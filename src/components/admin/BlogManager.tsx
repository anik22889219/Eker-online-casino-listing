                ...
                <div className="sm:col-span-2 border border-slate-100 bg-slate-50/55 p-4 rounded-2xl space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                    ...
                    <div className="space-y-2">
                      ...
                      {blogBannerUrl && (
                        <div className="relative h-20 rounded-lg overflow-hidden border border-slate-200 bg-slate-100 flex items-center justify-center">
                          <LightboxImage
                            src={blogBannerUrl}
                            alt="Banner Preview"
                            title="Article Banner Image"
                            subtitle={title || "Blog Post Banner"}
