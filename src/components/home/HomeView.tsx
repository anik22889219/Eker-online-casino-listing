...
import { MostWinningGamesSection } from "./MostWinningGamesSection";
...
export const HomeView: React.FC = () => {
  ...
  // Helper to filter casinos by section category
          ...
          {theme.sections.map((sec) => {
            ...
            switch (sec.type) {
              ...
              case "featured_operators": {
                const filtered = filterBySecCategory(featuredCasinos, sec.carouselCategory);
              ...
              case "latest_listings": {
                const filtered = filterBySecCategory(latestCasinos, sec.carouselCategory);
                return (
                  <section key={sec.id} className="space-y-5">
                    <div className="border-b border-slate-100 pb-2">
                      <div className="flex items-center gap-2">
              ...
              case "top_rated": {
                const filtered = filterBySecCategory(popularBonuses, sec.carouselCategory);
                return filtered.length > 0 ? (
                  <section key={sec.id} className="space-y-5">
                    <div className="border-b border-slate-100 pb-2">
                      <div className="flex items-center gap-2">
              ...
              case "most_winning_games":
                return <MostWinningGamesSection key={sec.id} config={sec} games={theme.mostWinningGames || []} />;
